...
$pdf->Cell(190, 30, 'Laporan Arsip Dokumen Keluar', 0, 1, 'C');
$pdf->Ln(-5);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(8, 6, 'ID', 1, 0, 'C');
$pdf->Cell(30, 6, 'Kategori', 1, 0, 'C');
$pdf->Cell(30, 6, 'No Dokumen', 1, 0, 'C');
$pdf->Cell(27, 6, 'No Arsip', 1, 0, 'C');
$pdf->Cell(30, 6, 'Tujuan Doc', 1, 0, 'C');
$pdf->Cell(35, 6, 'Tanggal Doc Keluar', 1, 0, 'C');
$pdf->Cell(30, 6, 'Tanggal Doc', 1, 0, 'C');
$pdf->SetFont('Arial', '', 10);

$doku = $this->db->query("SELECT * FROM tb_dokumen_Keluar")->result_array();
foreach ($doku as $dokumen) {
    ...
    $pdf->Ln(6);
    $pdf->Cell(8, 6, $dokumen['id_dokumen_keluar'], 1, 0, 'C');
    $pdf->Cell(30, 6, $kateg['nama_kategori'], 1, 0, 'C');
    $pdf->Cell(30, 6, $dokumen['no_dokumen'], 1, 0, 'C');
    $pdf->Cell(27, 6, $dokumen['no_arsip'], 1, 0, 'C');
    $pdf->Cell(30, 6, $dokumen['tujuan_dokumen'], 1, 0, 'C');
    $pdf->Cell(35, 6, $dokumen['tanggal_dokumen_keluar'], 1, 0, 'C');
